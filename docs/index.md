...
<section class="home-page-section home-page-trust-section" aria-label="Product facts">
  <div class="home-page-trust">
    <div class="home-page-trust-item"><span class="home-page-trust-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.1V12a10 10 0 1 1-5.9-9.1"/><path d="M22 4 12 14l-3-3"/></svg></span>Android available now</div>
    <div class="home-page-trust-item"><span class="home-page-trust-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4.5" width="18" height="12" rx="2"/><path d="M8 20.5h8"/><path d="M12 16.5v4"/></svg></span>SSH + Local Workspaces</div>
...
<section class="home-page-section home-page-use-case-section">
  <div class="home-page-section-head home-page-section-head-centered">
    <p class="home-page-eyebrow">Real Development Workflows</p>
    <h2 class="home-page-section-title">Built for real moments.</h2>
    <p class="home-page-section-copy">Three ways NimoteCode fits into the way you already work.</p>
  </div>
  <div class="home-page-use-case-grid">
    <a href="/use-cases/mobile-workspace-demo" class="home-page-use-case-card"><span>REMOTE CODING</span><h3>Continue development away from your desk.</h3><p>Open the same project on your Mac or Linux machine through SSH.</p></a>
    <a href="/use-cases/" class="home-page-use-case-card"><span>AI CODING AGENT</span><h3>Run AI coding workflows from mobile.</h3><p>Inspect, plan, execute and verify changes without returning to your laptop.</p></a>
    <a href="/use-cases/terminal-ai-tools" class="home-page-use-case-card"><span>ON-CALL / QUICK FIX</span><h3>Fix an issue when you're away from your desk.</h3><p>Inspect logs, edit a file, run tests and review the diff from your phone.</p></a>
  </div>
  <div class="home-page-section-cta">
    <a href="/use-cases/" class="home-page-btn secondary">Explore Workflows</a>
  </div>
</section>
<section class="home-page-section home-page-community-section">
  <div class="home-page-section-head home-page-section-head-centered">
    <p class="home-page-eyebrow">Community</p>
    <h2 class="home-page-section-title">Join the community.</h2>
    <p class="home-page-section-copy">Questions, workflow ideas or a bug to report — the fastest way to get answers is where NimoteCode developers already talk.</p>
  </div>
  <div class="home-page-community-grid">
    <a href="https://discord.gg/tTxbpqYmhR" class="home-page-community-card" target="_blank" rel="noreferrer">
      ...
      <h3>Discord</h3>
      <p>Community &amp; support — chat with the team and other developers, ask questions and share your mobile workflows.</p>
      <span class="home-page-community-cta">Join the Discord <span aria-hidden="true">→</span></span>
    </a>
    <a href="https://github.com/mobiledevloperlab" class="home-page-community-card" target="_blank" rel="noreferrer">
      ...
      <h3>GitHub</h3>
      <p>Releases &amp; issues — follow development, report problems and see what ships next.</p>
      <span class="home-page-community-cta">Follow on GitHub <span aria-hidden="true">→</span></span>
    </a>
    <a href="https://x.com/mobiledevlab" class="home-page-community-card" target="_blank" rel="noreferrer">
      ...
      <h3>X (Twitter)</h3>
      <p>Updates — release notes, product announcements and notes from building a mobile IDE.</p>
      <span class="home-page-community-cta">Follow on X <span aria-hidden="true">→</span></span>
    </a>
  </div>
</section>
<section class="home-page-section home-page-guide-section">
  <div class="home-page-section-head home-page-section-head-centered">
    <p class="home-page-eyebrow">Latest Guides</p>
    <h2 class="home-page-section-title">From our blog.</h2>
  ...
  <div class="home-page-guide-grid">
    <a href="/blog/best-mobile-ides" class="home-page-guide-card"><span>MOBILE IDE</span><h3>The Best Mobile IDEs in 2026</h3><p>What separates a real mobile workspace from SSH clients and editor-only apps.</p></a>
    <a href="/blog/can-an-ai-agent-really-code-from-a-phone" class="home-page-guide-card"><span>AI CODING</span><h3>Can an AI Agent Really Code From a Phone?</h3><p>Plan, edit, run and commit real changes from a phone over SSH.</p></a>
    <a href="/blog/tailscale-ssh-android-mac-linux" class="home-page-guide-card"><span>REMOTE DEVELOPMENT</span><h3>Android as a Remote IDE with Tailscale</h3><p>Free SSH access to Mac and Linux without a public IP or port forwarding.</p></a>
  </div>
</section>
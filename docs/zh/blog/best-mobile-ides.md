...
<p class="article-meta">发布于 2026-09-09 · NimoteCode 团队</p>
...
**连接模型。** 能否处理本地项目?能否通过你自己的安全网络(Tailscale、WireGuard、局域网)连到远程 Mac 或 Linux,而无需公网 IP 或端口映射?远程访问不应该被迫把凭据交给第三方中继。
...
NimoteCode 是为 Android 与 iOS 打造的移动 AI 开发工作区,把本地与远程项目当成同一种工作区对待:
...
| **NimoteCode** | **有——本地与 SSH** | **有,与工作区同处** | **有——推送前审查** | **有——带审批** | **设备与你掌控的机器上** |
